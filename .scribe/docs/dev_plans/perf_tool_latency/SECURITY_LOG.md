...
# 🔒 Security Log — perf-tool-latency
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: perf-tool-latency] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
