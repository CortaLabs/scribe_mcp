...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: council_proxy_test] Message text | severity=<severity>; component=<component>; status=<status>; [additional metadata]
```
