...
# 🐞 Bug Log — council_mcp_template_hardening
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: council_mcp_template_hardening] Message text | severity=<severity>; component=<component>; status=<status>; [additional metadata]
```
