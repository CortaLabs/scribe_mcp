...
Applies to: **v2.2.25 public release line**
...
- v2.2.25 keeps the fail-closed provenance guard for changelog/global reconciliation and adds git-clean managed-doc scaffold generation.
