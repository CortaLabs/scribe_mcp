...
# 🏗️ Architecture Guide — tmpy
**Author:** Scribe
**Version:** Draft v0.1
**Status:** Draft
**Last Updated:** 2026-02-15 08:00:33 UTC

> Architecture guide for tmpy.

---
## 1. Problem Statement
<!-- ID: problem_statement -->
- **Context:** tmpy needs a reliable documentation system.
- **Goals:**
...
```
/home/austin/projects/MCP_SPINE/scribe_mcp/docs/dev_plans/tmpy
```
