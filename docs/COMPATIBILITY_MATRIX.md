...
- **Core package version:** `scribe-mcp==2.2.6`
- **Optional template package:** `scribe-council==2.2.6`
...
| --- | --- | --- | --- |
| `2.2.6` | — | Supported | Standard install for local/core usage. |
| `2.2.6` | `2.2.6` | Supported | Add optional template bundle when template assets are needed. |

## Not supported by this baseline

| Combination / practice | Status | Why |
| --- | --- | --- |
| `scribe-council` without `scribe-mcp==2.2.6` | Unsupported | Optional package explicitly depends on `scribe-mcp==2.2.6`. |
