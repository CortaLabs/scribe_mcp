...
# 🔒 Security Log — path_test_12288c67
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: path_test_12288c67] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
