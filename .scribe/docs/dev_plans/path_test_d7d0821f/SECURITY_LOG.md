...
# 🔒 Security Log — path_test_d7d0821f
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: path_test_d7d0821f] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
