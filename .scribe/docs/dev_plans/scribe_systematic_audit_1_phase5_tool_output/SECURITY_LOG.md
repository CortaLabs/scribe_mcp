...
# 🔒 Security Log — scribe_systematic_audit_1_phase5_tool_output
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: scribe_systematic_audit_1_phase5_tool_output] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
