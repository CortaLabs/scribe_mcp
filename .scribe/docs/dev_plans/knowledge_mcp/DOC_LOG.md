...
# 📋 Documentation Update Log — knowledge_mcp
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: knowledge_mcp] Message text | doc=<doc_name>; section=<section_id>; action=<action_type>; [additional metadata]
```
