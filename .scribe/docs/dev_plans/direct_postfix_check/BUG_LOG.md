...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: direct_postfix_check] Message text | severity=<severity>; component=<component>; status=<status>; [additional metadata]
```
