...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: agent_ux_overhaul] Message text | severity=<severity>; component=<component>; status=<status>; [additional metadata]
```
