...
# 🔒 Security Log — test_db_upsert_debug
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: test_db_upsert_debug] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
