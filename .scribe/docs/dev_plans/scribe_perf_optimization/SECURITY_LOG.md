...
# 🔒 Security Log — scribe_perf_optimization
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: scribe_perf_optimization] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
