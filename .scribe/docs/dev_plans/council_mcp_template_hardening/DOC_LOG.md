...
# 📋 Documentation Update Log — council_mcp_template_hardening
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: council_mcp_template_hardening] Message text | doc=<doc_name>; section=<section_id>; action=<action_type>; [additional metadata]
```
