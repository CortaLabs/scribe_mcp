...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: db_routing_test] Message text | severity=<severity>; component=<component>; status=<status>; [additional metadata]
```
