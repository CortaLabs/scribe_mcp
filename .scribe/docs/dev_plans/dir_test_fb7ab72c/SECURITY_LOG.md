...
# 🔒 Security Log — dir_test_fb7ab72c
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: dir_test_fb7ab72c] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
