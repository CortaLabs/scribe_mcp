...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: test_priority_filters] Message text | severity=<severity>; component=<component>; status=<status>; [additional metadata]
```
