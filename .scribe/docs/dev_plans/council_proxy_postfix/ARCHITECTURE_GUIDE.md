...
# 🏗️ Architecture Guide — council_proxy_postfix
**Author:** Scribe
**Version:** Draft v0.1
**Status:** Draft
**Last Updated:** 2026-02-13 03:14:52 UTC

> Architecture guide for council_proxy_postfix.

---
## 1. Problem Statement
<!-- ID: problem_statement -->
- **Context:** council_proxy_postfix needs a reliable documentation system.
- **Goals:**
...
```
/home/austin/projects/MCP_SPINE/council_mcp/docs/dev_plans/council_proxy_postfix
```
