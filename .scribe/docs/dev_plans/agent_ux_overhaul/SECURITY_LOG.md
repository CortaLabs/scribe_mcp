...
# 🔒 Security Log — agent_ux_overhaul
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: agent_ux_overhaul] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
