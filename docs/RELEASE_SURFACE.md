...
Applies to: **v2.2.22 public release line**
...
- v2.2.22 adds a fail-closed provenance guard for changelog/global reconciliation: allowed safe sources still require non-empty `observed_context.value`.
