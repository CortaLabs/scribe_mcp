...
# 🔒 Security Log — custom_doc_edit_test
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: custom_doc_edit_test] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
