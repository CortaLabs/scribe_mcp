...
# 🐞 Bug Log — tool_call_latency_hotfix
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: tool_call_latency_hotfix] Message text | severity=<severity>; component=<component>; status=<status>; [additional metadata]
```
