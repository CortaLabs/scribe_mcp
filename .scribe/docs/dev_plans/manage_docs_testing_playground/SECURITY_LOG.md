...
# 🔒 Security Log — manage_docs_testing_playground
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: manage_docs_testing_playground] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
