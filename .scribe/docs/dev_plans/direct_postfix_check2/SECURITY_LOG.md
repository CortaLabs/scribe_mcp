...
# 🔒 Security Log — direct_postfix_check2
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: direct_postfix_check2] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
