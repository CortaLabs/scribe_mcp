...
# 🔒 Security Log — dir_test_8167a7d3
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: dir_test_8167a7d3] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
