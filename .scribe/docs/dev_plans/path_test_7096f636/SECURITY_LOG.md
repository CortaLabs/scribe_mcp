...
# 🔒 Security Log — path_test_7096f636
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: path_test_7096f636] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
