...
# 🔒 Security Log — debug_runtime_set_project
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: debug_runtime_set_project] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
