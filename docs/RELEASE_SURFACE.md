...
Applies to: **v2.2.24 public release line**
...
- v2.2.24 keeps the fail-closed provenance guard for changelog/global reconciliation and adds git-clean managed-doc scaffold generation.
