...
# 🔒 Security Log — test_project_alpha
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: test_project_alpha] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
