...
# 🐞 Bug Log — list_projects_root_filter_fix
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: list_projects_root_filter_fix] Message text | severity=<severity>; component=<component>; status=<status>; [additional metadata]
```
