...
# 🔒 Security Log — dir_test_6adac18d
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: dir_test_6adac18d] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
