...
# 🔒 Security Log — integrate-system-scribe-latency-20260616T050042Z
**Maintained By:** Scribe
**Timezone:** UTC

> Track security events, vulnerabilities, and decisions for Scribe MCP. Use `log_type="security"` (or `--log security`).
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: integrate-system-scribe-latency-20260616T050042Z] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
...
- **Data Storage**: Encryption, database security, data handling, global-vs-repo config ownership.
- **Network**: API security, segmentation, firewall rules.
- **Code Injection**: XSS, SQL injection, command injection.
- **Infrastructure**: Servers, containers, secrets management, MCP/runtime deployment.
- **Configuration**: Settings, permissions, access controls, downstream override surfaces.
