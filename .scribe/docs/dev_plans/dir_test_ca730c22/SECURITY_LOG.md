...
# 🔒 Security Log — dir_test_ca730c22
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: dir_test_ca730c22] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
