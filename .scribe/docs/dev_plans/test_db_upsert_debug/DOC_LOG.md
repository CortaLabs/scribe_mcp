...
# 📋 Documentation Update Log — test_db_upsert_debug
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: test_db_upsert_debug] Message text | doc=<doc_name>; section=<section_id>; action=<action_type>; [additional metadata]
```
