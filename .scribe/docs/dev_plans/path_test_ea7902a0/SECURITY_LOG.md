...
# 🔒 Security Log — path_test_ea7902a0
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: path_test_ea7902a0] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
