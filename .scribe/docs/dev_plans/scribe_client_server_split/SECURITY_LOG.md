...
# 🔒 Security Log — scribe_client_server_split
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: scribe_client_server_split] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
