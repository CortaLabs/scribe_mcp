...
# 🔒 Security Log — test_project_beta
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: test_project_beta] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
