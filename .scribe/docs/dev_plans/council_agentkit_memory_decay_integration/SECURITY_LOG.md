...
# 🔒 Security Log — council_agentkit_memory_decay_integration
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: council_agentkit_memory_decay_integration] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
