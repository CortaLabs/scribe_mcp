...
# 🔒 Security Log — dir_test_ff6ddbce
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: dir_test_ff6ddbce] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
