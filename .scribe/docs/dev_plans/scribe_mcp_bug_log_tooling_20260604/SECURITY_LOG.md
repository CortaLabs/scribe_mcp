...
# 🔒 Security Log — scribe_mcp_bug_log_tooling_20260604
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: scribe_mcp_bug_log_tooling_20260604] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
