...
# 🐞 Bug Log — read_file_search_audit
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: read_file_search_audit] Message text | severity=<severity>; component=<component>; status=<status>; [additional metadata]
```
