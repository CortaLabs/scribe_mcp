...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: scribe_codebase_audit] Message text | severity=<severity>; component=<component>; status=<status>; [additional metadata]
```
