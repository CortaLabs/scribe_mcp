...
# 🔒 Security Log — path_test_a22a567f
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: path_test_a22a567f] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
