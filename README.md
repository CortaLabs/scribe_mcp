...
`2.2.25` focuses on git-clean managed-doc scaffolds, agent-safe reference provenance, scoped case identity, preserve-first managed-doc metadata, and a provenance-safe changelog/global reconciliation guard:
