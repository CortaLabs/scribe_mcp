...
# 🔒 Security Log — agent_param_audit
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: agent_param_audit] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
