...
# 🏗️ Architecture Guide — council_mcp_v2
**Author:** Scribe
**Version:** Draft v0.1
**Status:** Draft
**Last Updated:** 2026-01-10 09:46:45 UTC

> Architecture guide for council_mcp_v2.

---
## 1. Problem Statement
<!-- ID: problem_statement -->
- **Context:** council_mcp_v2 needs a reliable documentation system.
- **Goals:**
...
```
/home/austin/projects/MCP_SPINE/scribe_mcp/docs/dev_plans/council_mcp_v2
```
