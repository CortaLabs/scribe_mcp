...
Applies to: **v2.7.0 public release line**
...
- v2.7.0 keeps the fail-closed provenance guard for changelog/global reconciliation, deterministic document topology, metadata scan/repair, quality handoff gates, agent-ready quality-check summaries/actions, bulk managed-doc checks, and sanitized downstream export manifests.
