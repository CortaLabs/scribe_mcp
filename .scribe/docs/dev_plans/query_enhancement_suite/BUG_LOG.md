...
# 🐞 Bug Log — query_enhancement_suite
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: query_enhancement_suite] Message text | severity=<severity>; component=<component>; status=<status>; [additional metadata]
```
