...
# 🔒 Security Log — mcp_debug_project
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: mcp_debug_project] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
