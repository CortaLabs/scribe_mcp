...
# 🔒 Security Log — review_agent_validation_test
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: review_agent_validation_test] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
