...
# 🔒 Security Log — path_test_8aa6193c
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: path_test_8aa6193c] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
