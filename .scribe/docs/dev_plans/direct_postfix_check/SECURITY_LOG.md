...
# 🔒 Security Log — direct_postfix_check
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: direct_postfix_check] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
