...
# 🔒 Security Log — scribe_pro_cleanup
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: scribe_pro_cleanup] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
