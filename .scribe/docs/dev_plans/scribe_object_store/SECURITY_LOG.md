...
# 🔒 Security Log — scribe_object_store
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: scribe_object_store] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
