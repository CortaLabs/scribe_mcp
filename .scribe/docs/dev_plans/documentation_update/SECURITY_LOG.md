...
# 🔒 Security Log — documentation_update
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: documentation_update] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
