...
# 🔒 Security Log — sitepkg_runtime_test
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: sitepkg_runtime_test] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
