...
# 🔒 Security Log — doc_param_refactor_test
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: doc_param_refactor_test] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
