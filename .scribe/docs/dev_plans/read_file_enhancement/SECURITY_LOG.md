...
# 🔒 Security Log — read_file_enhancement
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: read_file_enhancement] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
