...
Applies to: **v2.2.23 public release line**
...
- v2.2.23 keeps the fail-closed provenance guard for changelog/global reconciliation and adds git-clean managed-doc scaffold generation.
