...
# 🐞 Bug Log — slugify_standardization
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: slugify_standardization] Message text | severity=<severity>; component=<component>; status=<status>; [additional metadata]
```
