...
description: How to use Scribe MCP tools correctly — logging, docs, bugs, file reading, search
user-invocable: true
context: full
visibility: exported
owner: scribe-mcp
...
### Frontmatter, Status Intent, and Scaffold Quality Gates
...
- Run `quality_check` before handoff on managed docs, and run `project_health` before closeout.
