...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: read_search_error_ux] Message text | severity=<severity>; component=<component>; status=<status>; [additional metadata]
```
