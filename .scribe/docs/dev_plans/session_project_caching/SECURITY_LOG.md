...
# 🔒 Security Log — session_project_caching
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: session_project_caching] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
