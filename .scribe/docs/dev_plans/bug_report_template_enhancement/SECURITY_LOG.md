...
# 🔒 Security Log — bug_report_template_enhancement
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: bug_report_template_enhancement] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
