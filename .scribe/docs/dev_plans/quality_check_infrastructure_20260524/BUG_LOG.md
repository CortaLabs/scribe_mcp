...
# 🐞 Bug Log — quality_check_infrastructure_20260524
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: quality_check_infrastructure_20260524] Message text | severity=<severity>; component=<component>; status=<status>; [additional metadata]
```
