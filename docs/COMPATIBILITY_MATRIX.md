...
Release framing: **v2.2.25 compatibility baseline**

## Baseline contract

This baseline keeps compatibility posture for the 2.2.25 documentation wave:

- **Core package version:** `scribe-mcp==2.2.25`
...
| --- | --- | --- |
| `2.2.25` | Supported | Public Scribe install for local/core usage. |
