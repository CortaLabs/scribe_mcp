...
# 🔒 Security Log — session_isolation_test
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: session_isolation_test] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
