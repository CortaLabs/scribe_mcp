...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: mcp_debug_project] Message text | severity=<severity>; component=<component>; status=<status>; [additional metadata]
```
