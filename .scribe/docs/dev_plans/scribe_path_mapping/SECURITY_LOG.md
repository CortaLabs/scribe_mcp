...
# 🔒 Security Log — scribe_path_mapping
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: scribe_path_mapping] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
