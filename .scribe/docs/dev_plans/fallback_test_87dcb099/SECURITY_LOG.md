...
# 🔒 Security Log — fallback_test_87dcb099
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: fallback_test_87dcb099] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
