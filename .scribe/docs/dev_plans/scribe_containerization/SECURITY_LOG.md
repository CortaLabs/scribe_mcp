...
# 🔒 Security Log — scribe_containerization
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: scribe_containerization] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
