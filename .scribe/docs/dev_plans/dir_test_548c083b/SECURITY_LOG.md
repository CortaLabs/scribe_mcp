...
# 🔒 Security Log — dir_test_548c083b
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: dir_test_548c083b] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
