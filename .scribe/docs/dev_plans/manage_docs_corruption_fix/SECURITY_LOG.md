...
# 🔒 Security Log — manage_docs_corruption_fix
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: manage_docs_corruption_fix] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
