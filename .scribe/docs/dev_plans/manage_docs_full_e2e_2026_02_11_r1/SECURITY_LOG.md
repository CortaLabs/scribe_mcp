...
# 🔒 Security Log — manage_docs_full_e2e_2026_02_11_r1
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: manage_docs_full_e2e_2026_02_11_r1] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
