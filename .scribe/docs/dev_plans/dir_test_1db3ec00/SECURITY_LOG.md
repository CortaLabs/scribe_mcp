...
# 🔒 Security Log — dir_test_1db3ec00
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: dir_test_1db3ec00] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
