...
# 🔒 Security Log — dir_test_bc7c2c57
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: dir_test_bc7c2c57] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
