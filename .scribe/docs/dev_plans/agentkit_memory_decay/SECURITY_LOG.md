...
# 🔒 Security Log — agentkit_memory_decay
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: agentkit_memory_decay] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
