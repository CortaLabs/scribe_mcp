...
# 🔒 Security Log — path_test_0296e588
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: path_test_0296e588] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
